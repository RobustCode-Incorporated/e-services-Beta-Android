...
import 'package:e_services_beta/data/models/citoyen_model.dart';
import 'package:e_services_beta/data/models/commune_model.dart'; // Pour le modèle Commune
import 'package:e_services_beta/data/providers/auth_provider.dart';
import 'package:e_services_beta/data/providers/citoyen_provider.dart';
import 'package:e_services_beta/data/providers/commune_provider.dart'; // Pour récupérer le nom de la commune et province
import 'package:e_services_beta/presentation/screens/auth/login_screen.dart'; // Import pour LoginScreen
